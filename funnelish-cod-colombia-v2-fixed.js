...
(function () {
  ...
  function crearAutocompletado(input) {
    ...
    // 🔧 FIX: Asegurar que el input parent tenga position relative
    ...
    // 🔧 FIX: CSS más robusto y cross-browser
    box.style.cssText = [
    ...
    input.addEventListener('input', function () {
      ...
      res.forEach(function (ciudad) {
        ...
        // 🔧 FIX: CSS inline más específico para items
        item.style.cssText = [
    ...
    input.addEventListener('focus', function() {
      // Si ya hay valor, mostrar sugerencias

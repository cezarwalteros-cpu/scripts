(function(){
    ...
    function generarEmail() {
        if (!window.carritoAbandonado.emailGenerado) {
            window.carritoAbandonado.emailGenerado = 'cliente' + Math.random().toString().slice(2,10) + Date.now().toString().slice(-4) + '@codcolombia.co';
        }
        return window.carritoAbandonado.emailGenerado;
    }
